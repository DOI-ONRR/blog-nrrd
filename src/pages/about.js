...
const AboutPage = () => {
    ...
    <section>
        ...
        <ul>
            <li><a href="https://www.onrr.gov/" target="_blank">onrr.gov</a>: This is the public, front-facing site for ONRR. ONRR collects, accounts for, and verifies energy and mineral revenues. We then distribute the funds to States, American Indians, and the U.S. Treasury.</li>
            <li><a href="https://revenuedata.doi.gov/" target="_blank">revenuedata.doi.gov</a>: This site (also called NRRD) provides open data and contextual information about how natural resources and their revenues are managed in the United States.</li>
            <li><a href="https://blog-nrrd.doi.gov/" target="_blank">blog-nrrd.doi.gov</a>: You are currently on the about page for this blog! We use the blog to document our lessons learned from modernizing onrr.gov and NRRD.</li>
        </ul>
    </section>

    <section>
        <h2>History</h2>
        <p>The ODDD team’s origins began in 2014 with the creation of the NRRD site. The original NRRD site was designed and developed in partnership with digital services experts at the General Services Administration’s <a href="https://18f.gsa.gov/" target="_blank">18-F organization</a>.</p>
        ...
        <p>A full, detailed timeline can be found on <a href="https://github.com/DOI-ONRR/nrrd/wiki#project-background" target="_blank">our wiki</a>.</p>
    </section>
    ...
    <section>
        ...
        <p>We work in the open, with open-source tools. We believe this approach is a good fit for government. All of our site changes and issues are captured in our <a href="https://github.com/DOI-ONRR" target="_blank">GitHub repositories</a>, and anyone can clone our codebase.</p>
        ...
        <ul>
            <li><a href="https://digital.gov/resources/delivering-digital-first-public-experience/" target="_blank">The 21st Century IDEA</a></li>
            <li><a href="https://data.gov/open-gov/" target="_blank">The OPEN Government Data Act</a></li>
            <li><a href="https://www.section508.gov/" target="_blank">Section 508</a></li>
            <li><a href="https://www.plainlanguage.gov/law/" target="_blank">The Plain Language Writing Act of 2010</a></li>
            <li><a href="https://www.doi.gov/ocio/policy-mgmt-support/information-and-records-management/iq" target="_blank">The Information Quality Act</a></li>
        </ul>
    </section>
