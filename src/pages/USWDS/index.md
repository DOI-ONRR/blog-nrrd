...
We’ve identified [user types and scenarios](https://github.com/ONRR/onrr.gov-site/wiki/Product-framing#key-scenarios), which have already gone through [one round of updating](https://blog-nrrd.doi.gov/onrr-user-types/). In addition to user research, we use journey mapping to help us understand the user experience from start to finish.
