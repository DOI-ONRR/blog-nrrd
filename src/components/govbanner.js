    ...
    <div class="usa-accordion">
      <header class="usa-banner__header">
        <div class="usa-banner__inner">
          <div class="grid-col-auto height-105">
            <img
              aria-hidden="true"
          ...
          <div class="usa-banner__guidance tablet:grid-col-6">
            ...
            <div class="usa-media-block__body">
              <p>
                ...
                <strong class="margin-left-05">.gov</strong> website belongs to an official government
          ...
          <div class="usa-banner__guidance tablet:grid-col-6">
            ...
            <div class="usa-media-block__body">
              <p>
                ...
                <strong class="margin-left-05">lock</strong> (
